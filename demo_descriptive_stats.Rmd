---
title: "USP 634: Descriptive Stats"
author: "Liming Wang"
date: "April 11, 2017"
output: 
  html_document:
...
```{r load}
californiatod <- read.csv("lab/californiatod.csv"); attach(californiatod)
head(californiatod)
```
...
```{r}
table(region, railtype) # counts
prop.table(table(region, railtype), 2) * 100 #percentage
```
