...
\begin{center}
\includegraphics{C:/Users/elmue/Desktop/Data1_labs/pnorm.png}
\end{center}
...
1. First, compute the 9% **confidence intervals** for density by hand and looking up the z value from the r table, using R as a calculator. 
