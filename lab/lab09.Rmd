...
setwd("C:/Users/jamgreen/Desktop/USP634")
cali <- read.csv("C:/Users/jamgreen/Desktop/USP634/californiatod.csv")
```
...
Alternatively, if all your variables are numeric, you can first scale the variables and the ren-run the regression.
